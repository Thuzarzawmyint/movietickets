...
<center>  
        <h2 class="h1">Product Id you wanna Edit</h2><br><br><br>
        <form action="VEdit1.php" method="post" name="editform" onsubmit="showSuccessTicketMessage(event)">
            <input type="text" name="productid" id="productid"><br><br><br><br>
            <input type="submit" class="submit" name="edit" id="edit" value="Submit Id">
...
if (isset($_POST['edit'])) {
    ...
    if (is_numeric($productid)) {
        ...
        $sql_check = "SELECT * FROM movie WHERE Id=?";
        ...
        if (mysqli_num_rows($result_check) > 0) {
            $sql_delete = "DELETE FROM movie WHERE Id=?";
